...
// internal sealed class TriggerAnimationState :4116
// {
...
void TriggerAnimationState__FuseAnimationsIPlayerFeedbackOnProgressUpdated_fn(TriggerAnimationState* __this, uObject* s, bool* animating);
