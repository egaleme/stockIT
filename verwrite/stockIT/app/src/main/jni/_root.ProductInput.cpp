// This file was generated based on C:\stockit\stockit\.uno\ux11\ProductInput.g.uno.
...
// public partial sealed class ProductInput :2
// {
// static ProductInput() :4
static void ProductInput__cctor_3_fn(uType* __type)
{
}

static void ProductInput_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextInputControl_type* ProductInput_typeof()
{
    ...
    options.ObjectSize = sizeof(ProductInput);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextInputControl_type);
    type = (::g::Fuse::Controls::TextInputControl_type*)uClassType::New("ProductInput", options);
    type->fp_build_ = ProductInput_build;
    type->fp_ctor_ = (void*)ProductInput__New4_fn;
    type->fp_cctor_ = ProductInput__cctor_3_fn;
...
// public ProductInput() :8
void ProductInput__ctor_8_fn(ProductInput* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void ProductInput__InitializeUX_fn(ProductInput* __this)
{
    __this->InitializeUX();
}

// public ProductInput New() :8
void ProductInput__New4_fn(ProductInput** __retval)
{
    *__retval = ProductInput::New4();
}

// public ProductInput() [instance] :8
void ProductInput::ctor_8()
{
    ctor_7();
    InitializeUX();
}
...
void ProductInput::InitializeUX()
{
...
// public ProductInput New() [static] :8
ProductInput* ProductInput::New4()
{
    ProductInput* obj1 = (ProductInput*)uNew(ProductInput_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
