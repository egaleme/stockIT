...
// {
// static ProductText() :4
static void ProductText__cctor_4_fn(uType* __type)
{
}

static void ProductText_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* ProductText_typeof()
{
    ...
    options.ObjectSize = sizeof(ProductText);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("ProductText", options);
    type->fp_build_ = ProductText_build;
    type->fp_ctor_ = (void*)ProductText__New4_fn;
    type->fp_cctor_ = ProductText__cctor_4_fn;
...
// public ProductText New() :8
void ProductText__New4_fn(ProductText** __retval)
{
    *__retval = ProductText::New4();
}

// public ProductText() [instance] :8
void ProductText::ctor_8()
{
    ctor_7();
    InitializeUX();
}
...
void ProductText::InitializeUX()
{
    TextColor(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
}

// public ProductText New() [static] :8
ProductText* ProductText::New4()
{
    ProductText* obj1 = (ProductText*)uNew(ProductText_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
