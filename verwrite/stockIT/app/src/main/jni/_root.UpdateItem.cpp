// This file was generated based on C:\stockit\stockit\.uno\ux11\UpdateItem.g.uno.
...
// public partial sealed class UpdateItem :2
// {
// static UpdateItem() :16
static void UpdateItem__cctor_4_fn(uType* __type)
{
    UpdateItem::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 1, ::STRINGS[0/*"router"*/]);
    UpdateItem::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Value"*/]);
}

static void UpdateItem_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("quantity");
    ::STRINGS[8] = uString::Const("updateProduct");
    ::STRINGS[9] = uString::Const("Pages/updateitem.ux");
    ::STRINGS[10] = uString::Const("Edit Product");
    ...
    type->SetFields(99,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::UpdateItem, __g_nametable1), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(::g::UpdateItem, router), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::UpdateItem, temp_eb11), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::UpdateItem, temp_eb12), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::UpdateItem, temp_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::UpdateItem, temp1_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::UpdateItem, temp2_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::UpdateItem, temp3_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::UpdateItem, temp4_Value_inst), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::UpdateItem::__g_static_nametable1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::UpdateItem::__selector0_, uFieldFlagsStatic);
}

::g::Fuse::Controls::Control_type* UpdateItem_typeof()
{
    ...
    options.ObjectSize = sizeof(UpdateItem);
    options.TypeSize = sizeof(::g::Fuse::Controls::Control_type);
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("UpdateItem", options);
    type->fp_build_ = UpdateItem_build;
    type->fp_cctor_ = UpdateItem__cctor_4_fn;
...
// public UpdateItem(Fuse.Navigation.Router router) :20
void UpdateItem__ctor_7_fn(UpdateItem* __this, ::g::Fuse::Navigation::Router* router1)
{
    __this->ctor_7(router1);
}

// private void InitializeUX() :26
void UpdateItem__InitializeUX_fn(UpdateItem* __this)
{
    __this->InitializeUX();
}

// public UpdateItem New(Fuse.Navigation.Router router) :20
void UpdateItem__New4_fn(::g::Fuse::Navigation::Router* router1, UpdateItem** __retval)
{
    *__retval = UpdateItem::New4(router1);
}

uSStrong<uArray*> UpdateItem::__g_static_nametable1_;
::g::Uno::UX::Selector UpdateItem::__selector0_;

// public UpdateItem(Fuse.Navigation.Router router) [instance] :20
void UpdateItem::ctor_7(::g::Fuse::Navigation::Router* router1)
{
    ctor_6();
    router = router1;
    InitializeUX();
...
void UpdateItem::InitializeUX()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, UpdateItem::__g_static_nametable1());
    ::g::ProductInput* temp = ::g::ProductInput::New4();
    temp_Value_inst = ::g::stockIT_FuseControlsTextInputControl_Value_Property::New1(temp, UpdateItem::__selector0());
    ::g::ProductInput* temp1 = ::g::ProductInput::New4();
    temp1_Value_inst = ::g::stockIT_FuseControlsTextInputControl_Value_Property::New1(temp1, UpdateItem::__selector0());
    ::g::ProductInput* temp2 = ::g::ProductInput::New4();
    temp2_Value_inst = ::g::stockIT_FuseControlsTextInputControl_Value_Property::New1(temp2, UpdateItem::__selector0());
    ::g::ProductInput* temp3 = ::g::ProductInput::New4();
    temp3_Value_inst = ::g::stockIT_FuseControlsTextInputControl_Value_Property::New1(temp3, UpdateItem::__selector0());
    ::g::ProductInput* temp4 = ::g::ProductInput::New4();
    temp4_Value_inst = ::g::stockIT_FuseControlsTextInputControl_Value_Property::New1(temp4, UpdateItem::__selector0());
    ...
    temp_eb11 = ::g::Fuse::Reactive::EventBinding::New1(::STRINGS[2/*"goBack"*/]);
    ...
    ::g::Fuse::Reactive::DataBinding* temp13 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[1/*Fuse.Reactive.DataBinding<string>*/], temp_Value_inst, ::STRINGS[3/*"name"*/]);
    ...
    ::g::Fuse::Reactive::DataBinding* temp21 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[1/*Fuse.Reactive.DataBinding<string>*/], temp4_Value_inst, ::STRINGS[7/*"quantity"*/]);
    ...
    temp_eb12 = ::g::Fuse::Reactive::EventBinding::New1(::STRINGS[8/*"updateProduct"*/]);
    ...
    temp5->LineNumber(4);
    temp5->FileName(::STRINGS[9/*"Pages/updat...*/]);
    temp5->File(::g::Uno::UX::BundleFileSource::New1(::g::stockIT_bundle::updateitem6b24dcbc()));
    ...
    temp9->Value(::STRINGS[10/*"Edit Product"*/]);
    temp9->TextColor(::g::Fuse::Drawing::Colors::White());
    temp9->Alignment(10);
    temp10->Alignment(1);
    ::g::Fuse::Gestures::Clicked::AddHandler(temp10, uDelegate::New(::TYPES[3/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb11)));
    temp10->File(::g::Uno::UX::BundleFileSource::New1(::g::stockIT_bundle::directionLeft29fc53ef()));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp10->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb11);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp24, uDelegate::New(::TYPES[3/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb12)));
    temp24->Fill(temp26);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp24->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb12);
    temp25->Value(::STRINGS[16/*"Edit"*/]);
...
// public UpdateItem New(Fuse.Navigation.Router router) [static] :20
UpdateItem* UpdateItem::New4(::g::Fuse::Navigation::Router* router1)
{
    UpdateItem* obj1 = (UpdateItem*)uNew(UpdateItem_typeof());
    obj1->ctor_7(router1);
    return obj1;
}
// }
